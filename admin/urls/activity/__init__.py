...
urls = [url(r'^activity/list/(?P<id>\w+)?$', ActivityList.as_view(), name='activity_list'),
        ...
        url(r'^activity_user_participator/list/(?P<id>\w+)?$', ActivityUserParticipatorList.as_view(),
            name='activity_user_participator_list'),
        url(r'^activity_user_participator/(?P<id>\w+)$', ActivityUserParticipatorView.as_view(),
            name='activity_user_participator'), ]
